		...
		<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					<li><img class="img-responsive" src="images/ban4.png"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/ban5.png"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/ban3.png"
						alt="Dummy Image" /></li>
				</ul>
				...
				<div class="script-wrap">
					<ul class="script-group">
						<li><div class="inner-script">
								<img class="img-responsive" src="images/ban4.png"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/ban5.png"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/ban3.png"
									alt="Dummy Image" />
							</div></li>
					</ul>
